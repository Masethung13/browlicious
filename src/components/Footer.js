      ...
      <div className="footer-cta-banner">
        <div className="cta-banner-container">
          ...
          <p className="cta-banner-desc">
            Explore our treatments or speak with our specialists to find the right option for you.
          </p>
        ...
        <div className="values-ribbon-container">
          ...
          <div className="value-ribbon-item">
            ...
            <div className="value-text-block">
              ...
              <p className="value-desc">Highest clinical standards for your safety.</p>
            </div>
          </div>
          ...
          <div className="value-ribbon-item">
            ...
            <div className="value-text-block">
              ...
              <p className="value-desc">Highly trained and experienced experts.</p>
            </div>
          </div>
          ...
          <div className="value-ribbon-item">
            ...
            <div className="value-text-block">
              ...
              <p className="value-desc">Modern equipment and proven techniques.</p>
            </div>
          </div>
          ...
          <div className="value-ribbon-item">
            ...
            <div className="value-text-block">
              ...
              <p className="value-desc">Tailored treatments just for you.</p>
            </div>
          </div>
      ...
      <div className="footer-directory-block">
        <div className="directory-container">
          ...
          <div className="directory-column col-branding">
            ...
            <span className="footer-logo-sub">PREMIUM PERMANENT MAKEUP &amp; COSMETIC SURGERY CLINIC</span>
            <p className="footer-brand-narrative">
              Enhancing your natural beauty with expert care, advanced techniques, and a personal touch.
            </p>
            
            <div className="social-nodes-row">
              <a href="#" className="social-icon-outline" aria-label="Instagram">
              ...
              <a href="#" className="social-icon-outline" aria-label="Facebook">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="social-svg">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              <a href="#" className="social-icon-outline" aria-label="TikTok">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="social-svg">
                  <path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path>
                </svg>
              </a>
              <a href="#" className="social-icon-outline" aria-label="YouTube">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="social-svg">
              ...
              <a href="#" className="social-icon-outline" aria-label="Pinterest">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="social-svg">
          ...
          <div className="directory-column">
            ...
            <ul className="directory-list text-flat">
              ...
              <li><a href="#services">Eyeliner Tattoo</a></li>
